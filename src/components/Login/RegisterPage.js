...
import {registerUrl} from '../../common/Properties';
...
function RegistrationPage() {
  ...
  const validateForm = () => {
    ...
    if (!stockUsername) newErrors.stockUsername = 'Stock Username is required';
        ...
        <div className="login-wrapper">
            <div className="login-form-container">
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                    <Form.Label>Stock Username</Form.Label>
                    <Form.Control
                    type="username"
                    placeholder="Enter stock username"
                    value={stockUsername}
                    onChange={(e) => setStockUsername(e.target.value)}
                    isInvalid={!!errors.stockUsername}
                    />
                    <Form.Control.Feedback type="invalid">
                    {errors.stockUsername}
                    </Form.Control.Feedback>
                </Form.Group>
