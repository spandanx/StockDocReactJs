...
const ChartScreen = (props) => {
  ...
  function clicked(event){
    console.log("function clicked() called");
    console.log(event);
    var e = event.target;
    ...
    console.log(dim);
    console.log("left", dim.left, "right", dim.right, "top", dim.top, "bottom", dim.bottom);
    ...
    // console.log("offsetY", event.nativeEvent.offset);
